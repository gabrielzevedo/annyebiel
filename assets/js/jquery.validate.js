...
jQuery.validator.addMethod("validadeCartao", function (value, element) {
    var retorno = false;
    var RegExPattern = /^((0[1-9])|(1[0-2]))\/(([0-9][0-9])|([1-2][0,9][0-9][0-9]))$/;
    ...
    if (!((value.match(RegExPattern)) && (value != ''))) {
        ...
        var month = parseInt(value.slice(0, 2));
...
jQuery.validator.addMethod("dtNascimento", function (value) {
    value = value.replace(/([~!@#$%^&*()_+=`{}\[\]\-|\\:;'<>,.\/? ])+/g, "");
    if (value.length !== 8) {
        return false;
    }
...
jQuery.validator.addMethod("nomeCompleto", function (value) {
    var RegExPattern = /^((\b[A-zÀ-ú']{2,40}\b)\s*){2,}$/;
...
jQuery.validator.addMethod("cartaoCredito", function (value, element) {
    if (this.optional(element)) {
        return "dependency-mismatch";
    }
    if (/[^0-9 \-]+/.test(value)) {
